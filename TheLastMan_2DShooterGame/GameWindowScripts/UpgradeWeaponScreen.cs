...
using TheLastMan_2DShooterGame.GameScripts;
...
namespace TheLastMan_2DShooterGame.GameWindowScripts
{
    public class UpgradeWeaponScreen
    {
        ...
        private void SetUpgradeWeaponModal()
        {
            ...
            UpgradeWeaponModal.BackgroundImage = AssetsLoader.Instance.UI_BG["PanelBG"];
            UpgradeWeaponModal.BackgroundImageLayout = ImageLayout.Stretch;
        }
        private void SetBackgroundModal()
        {
            BackgroundModal = CustomControls.Instance.BackgroundModal(UpgradeWeaponModal);
        }
        private void SetUpgradeWeaponUI()
        {
            ...
            CurrentWeapon_Panel.BackgroundImage = AssetsLoader.Instance.UI_Borders["tile038"];
            ...
            CurrentWeapon_Pic.BackgroundImage = AssetsLoader.Instance.GO_Weapon[wName];
            ...
            NextWeapon_Panel.BackgroundImage = AssetsLoader.Instance.UI_Borders["tile038"];
            NextWeapon_Pic.Size = new Size(32, 32);
            NextWeapon_Pic.BackColor = Color.Transparent;
            NextWeapon_Pic.Location = new Point(16, 16);
            NextWeapon_Pic.BackgroundImage = AssetsLoader.Instance.GO_Weapon[nextWeaponName];
            ...
            GoldIcon.BackgroundImage = AssetsLoader.Instance.UI_Icons["Money Icon"];
        ...
        private void Upgrade_Button_Click(object sender,EventArgs e)
        {
            if (!nextWeaponName.Equals("-"))
            {
                ...
                {
                    MessageBox.Show("Bạn không đủ vàng để nâng cấp!");
                }
            }
            else
            {
                MessageBox.Show("Vũ khí của bạn đã đạt mức tối đa!");
            }
        }
        //Updating
        public void UpdateUI()
        {
            ...
            CurrentWeapon_Pic.BackgroundImage = AssetsLoader.Instance.GO_Weapon[currWeaponName];
            NextWeapon_Pic.BackgroundImage = AssetsLoader.Instance.GO_Weapon[nextWeaponName];
        }
