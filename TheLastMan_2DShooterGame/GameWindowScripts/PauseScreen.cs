...
using TheLastMan_2DShooterGame.GameWindowScripts;
...
namespace TheLastMan_2DShooterGame
{
    public class PauseScreen
    {
        ...
        private void SetPauseModal()
        {
            ...
            PauseModal.BackgroundImage = AssetsLoader.Instance.UI_BG["PanelBG"];
            PauseModal.BackgroundImageLayout = ImageLayout.Stretch;
        }
        private void SetBackgroundModal()
        {
            BackgroundModal = CustomControls.Instance.BackgroundModal(PauseModal);
        }
