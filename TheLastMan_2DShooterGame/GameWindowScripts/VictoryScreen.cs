...
namespace TheLastMan_2DShooterGame.GameWindowScripts
{
    public class VictoryScreen
    {
        ...
        private void SetVictoryModal()
        {
            ...
            VictoryModal.BackgroundImage = AssetsLoader.Instance.UI_BG["PanelBG"];
            VictoryModal.BackgroundImageLayout = ImageLayout.Stretch;
        }
        private void SetBackgroundModal()
        {
            BackgroundModal = CustomControls.Instance.BackgroundModal(VictoryModal);
        }
        private void SetVictoryUI()
        {
            ...
            StarPic.BackgroundImage = AssetsLoader.Instance.UI_Icons["Star Icon"];
            StarPic.BackgroundImageLayout = ImageLayout.Stretch;

            Content_Label = CustomControls.Instance.CustomLabel(
                "Chúc mừng nhân vật: " + GameManager.Instance.P.GetPlayerName()+"\n" +
                "Bản đồ: " + GameManager.Instance.Map_Name+"\n"+
        ...
        {
            Content_Label.Text = "Chúc mừng nhân vật: " + GameManager.Instance.P.GetPlayerName() + "\n" +
                "Bản đồ: " + GameManager.Instance.Map_Name + "\n" +
                "Thời gian bắt đầu: \n" +"\t\t\t"+ GameManager.Instance.P.GetPlayerCreatedAt() + "\n" +
                "Thòi gian hoàn thành: \n" +"\t\t\t"+ DateTime.Now.ToString();
