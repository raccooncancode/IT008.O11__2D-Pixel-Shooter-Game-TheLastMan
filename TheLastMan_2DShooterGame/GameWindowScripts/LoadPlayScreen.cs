...
namespace TheLastMan_2DShooterGame
{
    public class LoadPlayScreen
    {
        ...
        private void SetLoadPlayModal()
        {
            ...
            LoadPlayModal.BackgroundImage = AssetsLoader.Instance.UI_BG["PanelBG"];
            LoadPlayModal.BackgroundImageLayout = ImageLayout.Stretch;
        }
        private void SetBackgroundModal()
        {
            BackgroundModal = CustomControls.Instance.BackgroundModal(LoadPlayModal);
        }
        ...
        private void DoPlayAgain()
        {
            ...
            if (row != null)
            {
                ...
                {
                    MessageBox.Show("Màn chơi đã chiến thắng và hoàn tất");
                }
            }
        }
        public void DoOpen()
