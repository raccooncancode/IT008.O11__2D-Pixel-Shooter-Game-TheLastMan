...
namespace TheLastMan_2DShooterGame.GameWindowScripts
{
    public class InventoryScreen
    {
        ...
        private void SetInventoryModal()
        {
            ...
            InventoryModal.BackgroundImage =  AssetsLoader.Instance.UI_BG["PanelBG"];
            InventoryModal.BackgroundImageLayout = ImageLayout.Stretch;
        }
        private void SetBackgroundModal()
        {
            BackgroundModal = CustomControls.Instance.BackgroundModal(InventoryModal);
        }
            ...
            for (int j = 0; j < tb.Rows.Count; j++)
            {
                ...
                if (PID.Equals(GameManager.Instance.P.GetPlayerID()))
                {
                    ...
                    UseBtn.Click += (object sender, EventArgs e) =>
                    {
                        ...
                        {
                            MessageBox.Show("Vật phẩm đã sử dụng hết");
                        }
                    };
                    border.Name = IID;
                    ...
                    item_Pic.BackgroundImage = AssetsLoader.Instance.GO_Item[Item_Name];
