...
namespace TheLastMan_2DShooterGame.GameWindowScripts
{
    public class FailScreen
    {
        ...
        private void SetFailModal()
        {
            ...
            FailModal.BackgroundImage = AssetsLoader.Instance.UI_BG["PanelBG"];
            FailModal.BackgroundImageLayout = ImageLayout.Stretch;
        }
        private void SetBackgroundModal()
        {
            BackgroundModal = CustomControls.Instance.BackgroundModal(FailModal);
        }
