...
namespace TheLastMan_2DShooterGame.GameScripts
{
    public class GameUI
    {
        private GameUI() { }
        ...
        private void SetGameCanvas()
        {
            ...
            gameCanvas.BackgroundImage = AssetsLoader.Instance.UI_Maps[GameManager.Instance.Map_Name];
        ...
        public void GameCanvas_Paint(object sender ,PaintEventArgs e)
        {
            ...
            var hpImg = AssetsLoader.Instance.UI_Panels["HPPanel"];
            var ammoImg = AssetsLoader.Instance.UI_Panels["AmmoPanel"];
            var moneyImg = AssetsLoader.Instance.UI_Panels["MoneyPanel"];
            var stagePanel = AssetsLoader.Instance.UI_Icon_Stages[GameManager.Instance.Stage <=10 ? GameManager.Instance.Stage.ToString(): "10"];
